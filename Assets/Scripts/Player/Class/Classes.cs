...
{
    public static readonly PlayerClass WARRIOR = new PlayerClass("wizard", new ClassInventory(ItemType.Sword, ItemType.Helm, ItemType.Armor), new StatData(10f, 10f), new StatData(1f, 2f), new StatData(1f, 2f));
